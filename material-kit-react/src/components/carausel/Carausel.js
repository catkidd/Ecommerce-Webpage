  ...
  return (
    <Carousel>
      <Carousel.Item className="animate__animated animate__slideInLeft">
        <img className="d-block w-100" src="/Landing Page/1.jpg" alt="First slide" />
      ...
      <Carousel.Item className="animate__animated animate__slideInRight">
        <img className="d-block w-100" src="/Landing Page/2.jpg" alt="Second slide" />
      ...
      <Carousel.Item className="animate__animated animate__slideInLeft">
        <img className="d-block w-100" src="/Landing Page/3.jpg" alt="Third slide" />
